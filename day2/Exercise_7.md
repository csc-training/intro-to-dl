...
directory like
`/scratch/project_462001275/data/users/$USER/gpt-imdb-model/`, where
`$USER` is replaced with your username on LUMI. Take a look into that
directory:

```
ls -ltr /scratch/project_462001275/data/users/$USER/gpt-imdb-model/
```
...
`/scratch/project_462001275/data/users/$USER/gpt-imdb-model/checkpoint-5000`
...
```
path_to_model = "/scratch/project_462001275/data/users/mvsjober/gpt-imdb-model-checkpoint-145300-backup/"
```
