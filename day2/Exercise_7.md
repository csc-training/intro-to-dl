...
15 minutes on Roihu. Here are Hugging Face's notes on the many things
...
directory like
`/scratch/project_2020307/data/users/$USER/gpt-imdb-model/`, where
`$USER` is replaced with your username on Roihu. Take a look into that
directory:

```
ls -ltr /scratch/project_2020307/data/users/$USER/gpt-imdb-model/
```
...
`/scratch/project_2020307/data/users/$USER/gpt-imdb-model/checkpoint-5000`
...
```
path_to_model = "/scratch/project_2020307/data/users/mvsjober/gpt-imdb-model-checkpoint-50000/"
```
