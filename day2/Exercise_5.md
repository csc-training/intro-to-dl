...
`/scratch/project_462001275/data/avp` on LUMI.  Modify the scripts for
_Dogs vs. cats_ to classify between them. There is no test dataset, use the validation dataset as the test dataset in this case.
