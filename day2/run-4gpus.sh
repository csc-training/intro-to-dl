...
#SBATCH --cpus-per-task=288 # Number of CPU cores allocated to the task
#SBATCH --gres=gpu:gh200:4 # Number of GPUs allocated to the task
#SBATCH --mem=868344mb # Total RAM allocated for the job
